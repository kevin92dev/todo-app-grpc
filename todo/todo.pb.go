...
var file_todo_proto_rawDesc = []byte{
	...
	0x6f, 0x2e, 0x54, 0x65, 0x78, 0x74, 0x1a, 0x0a, 0x2e, 0x74, 0x6f, 0x64, 0x6f, 0x2e, 0x56, 0x6f,
	0x69, 0x64, 0x22, 0x00, 0x42, 0x04, 0x5a, 0x02, 0x2e, 0x2f, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x33,
}
...
var file_todo_proto_goTypes = []interface{}{
	(*Task)(nil),     // 0: client.Task
	(*TaskList)(nil), // 1: client.TaskList
	(*Text)(nil),     // 2: client.Text
	(*Void)(nil),     // 3: client.Void
}
var file_todo_proto_depIdxs = []int32{
	0, // 0: client.TaskList.tasks:type_name -> client.Task
	3, // 1: client.Tasks.List:input_type -> client.Void
	2, // 2: client.Tasks.Add:input_type -> client.Text
	1, // 3: client.Tasks.List:output_type -> client.TaskList
	3, // 4: client.Tasks.Add:output_type -> client.Void
